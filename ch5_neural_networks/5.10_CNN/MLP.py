...
class HiddenLayer(object):
    def __init__(self, rng, input, n_in, n_out, W=None, b=None,
        ...
        self.output = (
            ...
            else activation(lin_output)  # for different activation
        )
...
def test_mlp(learning_rate=0.01, L1_reg=0.00, L2_reg=0.0001, n_epochs=1000,
    ...
    @return: err: array, the error rate [train, valid, test] with model training
    """
    ...
    # display some chars:
    display_head(train_set_x, train_set_y, n = 5)
...
#             cost_train.append(minibatch_avg_cost)
            ...
            if (iter + 1) % validation_frequency == 0:
                ...
                if this_validation_loss < best_validation_loss:
                    ...
                    best_validation_loss = this_validation_loss  # the best result of current
                    best_iter = iter
            ...
            if patience <= iter:  # reach iteration time limitation
                done_looping = True
                break
...
if __name__ == '__main__':
    ...
    err_train, err_valid, err_test = test_mlp(
            learning_rate=0.01, 
            L1_reg=0.00,
            L2_reg=0.0001, 
            n_epochs=1000,
